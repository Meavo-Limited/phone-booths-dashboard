...
export class DashboardService {
     ...
     * @throws ApiError
     */
    public static dashboardStats(data: DashboardDashboardStatsData = {}): CancelablePromise<DashboardDashboardStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class ImportsService {
    /**
     * Import Phone Booths Csv
     * @param data The data for the request.
     * @param data.formData
     * @returns ImportResult Successful Response
     * @throws ApiError
     */
    public static importPhoneBoothsCsv(data: ImportsImportPhoneBoothsCsvData): CancelablePromise<ImportsImportPhoneBoothsCsvResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/csv-imports/phone-booths-sensors',
...
export class PhoneBoothsService {
     ...
     * @throws ApiError
     */
    public static readPhoneBoothsByIds(data: PhoneBoothsReadPhoneBoothsByIdsData = {}): CancelablePromise<PhoneBoothsReadPhoneBoothsByIdsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/phone-booths/by-ids',
            query: {
     ...
     * @param data.startDate
     * @param data.endDate
     * @param data.workdayStart
     * @param data.workdayEnd
     * @param data.workdaysMask
     * @returns WorkdayResponse Successful Response
     * @throws ApiError
     */
    public static calculateWorkingTime(data: PhoneBoothsCalculateWorkingTimeData): CancelablePromise<PhoneBoothsCalculateWorkingTimeResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/phone-booths/calculate-working-time',
            query: {
                start_date: data.startDate,
                end_date: data.endDate,
                workday_start: data.workdayStart,
                workday_end: data.workdayEnd,
                workdays_mask: data.workdaysMask
            },
            errors: {
                422: 'Validation Error'
            }
     ...
     * @throws ApiError
     */
    public static bulkUpdateWorkdaySettings(data: PhoneBoothsBulkUpdateWorkdaySettingsData): CancelablePromise<PhoneBoothsBulkUpdateWorkdaySettingsResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/phone-booths/workday/bulk-update',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
...
export class UsageSessionsService {
     ...
     * @param data.startDate Inclusive start date YYYY-MM-DD
     * @param data.endDate Inclusive end date YYYY-MM-DD
     * @param data.boothIds Comma-separated booth UUIDs. If empty: fetch all booths for current user.
     * @returns UsageReportDay Successful Response
     * @throws ApiError
     */
    public static usageReportsCharts(data: UsageSessionsUsageReportsChartsData): CancelablePromise<UsageSessionsUsageReportsChartsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/usage-sessions/charts',
            query: {
                booth_ids: data.boothIds,
                start_date: data.startDate,
                end_date: data.endDate
