...
export class DashboardService {
     ...
     * @throws ApiError
     */
    public static dashboardStats(): CancelablePromise<DashboardDashboardStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
