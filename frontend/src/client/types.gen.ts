...
export type Body_imports_import_phone_booths_csv = {
    file: (Blob | File);
};
...
export type ImportsImportPhoneBoothsCsvData = {
    formData: Body_imports_import_phone_booths_csv;
};

export type ImportsImportPhoneBoothsCsvResponse = (ImportResult);
