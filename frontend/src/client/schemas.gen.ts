...
export const Body_imports_import_phone_booths_csvSchema = {
    properties: {
        file: {
            type: 'string',
            format: 'binary',
    ...
    type: 'object',
    required: ['file'],
    title: 'Body_imports-import_phone_booths_csv'
} as const;
...
export const ImportErrorRowSchema = {
    properties: {
        row: {
            type: 'integer',
            title: 'Row'
...
export const ImportResultSchema = {
    ...
    type: 'object',
    required: ['total_rows', 'created', 'skipped', 'errors'],
    title: 'ImportResult'
} as const;
